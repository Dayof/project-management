...
_DEPS=catch.hpp UI.hpp Business.hpp Persistence.hpp Domain.hpp Entity.hpp sqlite3.h
DEPS=$(patsubst %,$(DIR_INC)%,$(_DEPS))

_OBJ=Main.o UI.o Business.o Persistence.o Entity.o Domain.o Test.o sqlite3.o
